...
def get_1min_Bitpanda(tradingpair):
    ...
    url = f"https://api.exchange.bitpanda.com/public/v1/candlesticks/{tradingpair}?unit=MINUTES&period=1&from=2022-04-11T04%3A59%3A59.999Z&to=2022-04-11T07%3A59%3A59.999Z"
